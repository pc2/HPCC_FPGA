...
if (INTELFPGAOPENCL_FOUND)
    ...
    foreach (kernel_target ${kernel_emulation_targets_intel})
        ...
        add_test(NAME test_unit_${kernel_target} COMMAND $<TARGET_FILE:${HOST_EXE_NAME}_test_intel> ${additional_commands} -f ${kernel_name} ${TEST_HOST_FLAGS} WORKING_DIRECTORY ${TEST_WORKING_DIRECTORY})
...
if (Vitis_FOUND)
    ...
    foreach (kernel_target ${kernel_emulation_targets_xilinx})
        ...
        add_test(NAME test_unit_${kernel_target} COMMAND $<TARGET_FILE:${HOST_EXE_NAME}_test_xilinx> -f ${kernel_name} ${TEST_HOST_FLAGS} WORKING_DIRECTORY ${TEST_WORKING_DIRECTORY})
    endforeach(kernel_target)
endif()

...
if (INTELFPGAOPENCL_FOUND)
    ...
    foreach (kernel_target ${kernel_emulation_targets_intel})
        ...
        if (${kernel_target} MATCHES ".+_IEC.+")
            list(APPEND additional_commands "--connectivity" "IEC")
        endif()
        if (${kernel_target} MATCHES ".+_PCIE.+")
            list(APPEND additional_commands "--connectivity" "PCIE")
        endif()
